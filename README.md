...
## Manual Chat
I don't have it create a new album I don't think. The chat name needs updated manually for this. As well as the chat id needing updated manually for this.
